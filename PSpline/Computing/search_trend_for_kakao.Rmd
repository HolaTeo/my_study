...
lambda[which.min(GCV_vec)]
naive_out <- naive_ss_p(beta_hat_vec = unlist(beta_hat[,1]), B=GetBSpline(unlist(beta_hat[,1]), deg = 3, IK, EK),  D=GetDiffMatrix(dim(B)[1],2),lambda=9999999999999)
